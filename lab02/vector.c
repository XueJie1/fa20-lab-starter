...
vector_t *bad_vector_new() {
    ...
    retval->size = 1;   // haven't checked if *retval or v is NULL, may cause Segmentation Fault
...
vector_t also_bad_vector_new() {
    /* Create the vector */
    vector_t v; // v is a local variable, would be cleared after the function's been executed and returned
